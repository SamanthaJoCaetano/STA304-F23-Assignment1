...
There are two attempts to submit this assignment. If you submit prior to the September 28 11:59pm ET deadline, then we will the latest submission that came in prior to Sept 28 11:59pm ET.

If you wish to use the grace period please do NOT submit prior to September 28 11:59pm ET. Note:if you used the grace period we will grade the latest submission, so please ensure that you are including BOTH the pdf and Rmd in your upload/submission. Note: there is an Ouriginal draft submission page available (not for grades) for you to practice submitting your assignment if needed.
